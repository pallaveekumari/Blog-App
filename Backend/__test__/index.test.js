...
describe('User Endpoints', () => {
  ...
  test('should retrieve a user by id', async () => {
    ...
    expect(response.body).toHaveProperty('created_at', newUser.created_at.toISOString());
    expect(response.body).toHaveProperty('updated_at', newUser.updated_at.toISOString());
  });
  ...
  test('should update a user by id', async () => {
    ...
    expect(response.body).toHaveProperty('created_at', newUser.created_at.toISOString());
    expect(response.body.updated_at).not.toEqual(newUser.updated_at.toISOString());
  });
...
describe('Post Endpoints', () => {
  ...
  test('should retrieve a post by id', async () => {
    ...
    expect(response.body).toHaveProperty('created_at', newPost.created_at.toISOString());
    expect(response.body).toHaveProperty('updated_at', newPost.updated_at.toISOString());
  ...
  test('should update a post by id', async () => {
    ...
    expect(response.body).toHaveProperty('created_at', newPost.created_at.toISOString());
    expect(response.body.updated_at).not.toEqual(newPost.updated_at.toISOString());
    expect(response.body).toHaveProperty('likes', newPost.likes);
  });
